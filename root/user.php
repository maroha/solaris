...
div#photo_showcase{float:right; width:136px; height:127px; background:url(style/photo_showcase_bg.jpg) no-repeat; width:136px; height:127px; margin:20px 30px 0px 0px; cursor:pointer;}
...
textarea#statustext{width:982; height:80px; padding:8px; border:#999 1px solid; font-size:16px;}
...
div.status_boxes > button > b{padding:5px; font-size:12px;}
...
<div id="pageMiddle">
  ...
  <hr />
  <p><?php include_once("template_status.php"); ?></p>
</div>
